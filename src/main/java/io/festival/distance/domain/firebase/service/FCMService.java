...
public class FCMService {
	public static notificationDto sendNotification(String senderNickName, String clientToken, String chatMessage) {
	...
	private static Message createNotificationContent(String senderNickName, String receiverClientToken, String chatMessage) {
		// 알림 내용
